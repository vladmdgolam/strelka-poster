...
const noReactDomError = () => {
  throw new Error(
    `Html component requires a 'react-dom' package, please install it`
  )
}
  ...
  (
    ...
    React.useEffect(() => {
      if (group.current) {
        ...
        el.style.cssText = `position:absolute;top:0;left:0;bottom:0; right:0; pointer-events: none; overflow:hidden;`
